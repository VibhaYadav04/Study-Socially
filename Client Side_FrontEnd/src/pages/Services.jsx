        ...
        <Base>
          <div style={containerStyle}>
            ...
            <ol style={listStyle}>
              ...
              <li style={listItemStyle}><strong>Create a Note:</strong> Once signed in, navigate to the 'Create Note' section.</li>
              ...
              <li style={listItemStyle}><strong>Choose a Category:</strong> Select the appropriate category for your note from the available options.</li>
              ...
              <li style={listItemStyle}><strong>Update if Needed:</strong> You can always go back and update your blog post if necessary.</li>
            </ol>
            <p style={textStyle}>
